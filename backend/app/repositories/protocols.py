...
@runtime_checkable
class CampaignMaterialRepository(Protocol):
    async def list_by_campaign(self, campaign_id: str) -> list[dict]: ...
    async def create_or_update(
        self, campaign_id: str, material_id: str, created_by: str | None = None, **kwargs
    ) -> dict: ...
    async def update(self, binding_id: str, **kwargs) -> dict | None: ...
    async def delete(self, binding_id: str) -> object | None: ...
