...
class MaterialBase(BaseModel):
    ...
    ctr_estimate: Optional[float] = Field(None, ge=0, description="CTR 预估")
    roi: Optional[float] = Field(None, ge=0, description="ROI")
    spend: Optional[float] = Field(None, ge=0, description="消耗")
    campaign_id: Optional[str] = Field(None, description="主关联广告计划 ID")
