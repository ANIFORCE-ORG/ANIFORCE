...
<template>
  <section class="analysis-table-card" :aria-label="props.title">
    ...
    <footer class="analysis-table-pagination"><span>共 {{ filteredRows.length }} 条 · 每页 {{ props.pageSize }} 条</span><div><button type="button" :disabled="currentPage === 1" @click="currentPage--">上一页</button><span>第 {{ currentPage }} / {{ pageCount }} 页</span><button type="button" :disabled="currentPage === pageCount" @click="currentPage++">下一页</button></div></footer>
  </section>
</template>
...
.analysis-table-header-actions { display: flex; align-items: center; gap: 8px; }.analysis-table-search { width: 220px; display: flex; align-items: center; gap: 6px; padding: 8px 10px; border: 1px solid #d8d5d0; border-radius: 8px; color: #9b9a97; }.analysis-table-search input { width: 100%; border: 0; outline: 0; font: inherit; font-size: 12px; }.analysis-table-search .material-symbols-outlined { font-size: 17px; }.analysis-table-count { padding: 8px 10px; border-radius: 7px; background: #f6f5f4; font-size: 12px; white-space: nowrap; }.analysis-attention-button,.analysis-table-pagination button { padding: 7px 10px; border: 1px solid #d8d5d0; border-radius: 7px; background: #fff; color: #56534f; font: inherit; font-size: 11px; cursor: pointer; white-space: nowrap; }.analysis-attention-button.active { background: #f3eee6; border-color: #cbb796; }.analysis-table { width: 100%; border-collapse: collapse; table-layout: auto; font-size: 12px; }.analysis-table th,.analysis-table td { padding: 11px 12px; border-bottom: 1px solid #ede9e4; text-align: right; white-space: nowrap; }.analysis-table th:first-child,.analysis-table td:first-child { width: 28%; text-align: left; }.analysis-table thead { background: #fafaf9; color: #787774; font-size: 11px; }.analysis-table td:first-child strong,.analysis-table td:first-child small { display: block; overflow: hidden; text-overflow: ellipsis; }.analysis-table td:first-child small { margin-top: 3px; color: #9b9a97; font-size: 10px; }.analysis-table td.up { color: #12804a; }.analysis-table td.down { color: #c73c36; }.analysis-status { color: #12804a; }.analysis-status.warning { color: #a86400; }.analysis-status.danger { color: #c73c36; }.analysis-table-empty { height: 130px; text-align: center !important; color: #787774; }.analysis-table tfoot th { background: #fafaf9; font-weight: 650; }.analysis-table-pagination { display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; color: #787774; font-size: 11px; }.analysis-table-pagination div { display: flex; align-items: center; gap: 10px; }
@media (max-width: 860px) { .analysis-table-titlebar,.analysis-table-pagination { align-items: stretch; flex-direction: column; }.analysis-table-header-actions { flex-wrap: wrap; }.analysis-table-search { flex: 1 1 200px; width: auto; }.analysis-table-scroll { overflow-x: auto; } }
</style>
