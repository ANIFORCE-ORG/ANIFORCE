  ...
  <div>
    ...
    >
      <div
        ...
        :key="creative.id"
        class="group relative cursor-pointer overflow-hidden rounded-md border border-slate-200 bg-white transition-all hover:shadow-lg dark:border-slate-700 dark:bg-slate-800"
      ...
      >
        ...
        <button
          v-if="embedded"
          class="absolute top-[8px] right-[8px] z-10 rounded-md border border-slate-200 bg-white/95 px-[8px] py-[5px] text-[10px] font-medium text-slate-600 opacity-0 shadow-sm transition-colors hover:border-primary/30 hover:text-primary group-hover:opacity-100 dark:border-slate-700 dark:bg-slate-900/95 dark:text-slate-300"
          title="加入当前对话上下文"
