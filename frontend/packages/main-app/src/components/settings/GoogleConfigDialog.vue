  ...
  >
    <div class="bg-white dark:bg-slate-800 rounded-md shadow-lg max-w-[750px] w-full">
      ...
      <div class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-[19px] py-[12px] flex items-center justify-between rounded-t-xl">
        <h2 class="text-[15px] font-bold text-slate-900 dark:text-white">Google OAuth 配置</h2>
        <button
      ...
      <div class="p-[19px] space-y-[19px]">
        ...
        <section>
          <div class="space-y-[12px]">
            ...
            <label class="block">
              <span class="text-[10px] font-medium text-slate-600 dark:text-slate-400">Client ID</span>
              <input
            ...
            <label class="block">
              <span class="text-[10px] font-medium text-slate-600 dark:text-slate-400">Client Secret</span>
