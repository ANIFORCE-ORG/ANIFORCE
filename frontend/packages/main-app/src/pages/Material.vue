  ...
  <main class="flex-1 px-6 py-12 md:px-12">
    <div class="mx-auto max-w-5xl">
      <div class="flex items-center gap-3 mb-8">
        ...
        <h1 class="text-3xl font-bold tracking-tight">素材生产</h1>
      </div>
      <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-12 text-center">
        ...
        <p class="text-lg text-slate-500 dark:text-slate-400">素材生产功能开发中...</p>
        <p class="text-sm text-slate-400 dark:text-slate-500 mt-2">AI 驱动的广告素材自动生成</p>
      </div>
    </div>
  </main>
</template>
