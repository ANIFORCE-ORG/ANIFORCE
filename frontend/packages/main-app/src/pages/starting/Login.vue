          ...
          <div>
            ...
            <div class="space-y-3">
              ...
              <button
                ...
                class="w-full py-3 px-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-slate-300 dark:hover:border-slate-600 transition-all flex items-center justify-center gap-3"
              >
                ...
                <span class="text-slate-700 dark:text-slate-300 text-sm font-medium">使用 Google 登录</span>
              </button>
              ...
              >
                ...
                <span class="text-slate-700 dark:text-slate-300 text-sm font-medium">使用 Meta 登录</span>
              </button>
            </div>
