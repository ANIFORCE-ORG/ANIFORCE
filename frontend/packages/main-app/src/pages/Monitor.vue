...
<template>
  <div class="workspace-page-canvas flex h-screen w-full overflow-hidden dark:bg-slate-950">
    ...
    <main class="workspace-page-canvas flex flex-1 flex-col overflow-hidden dark:bg-slate-950">
      <div data-workspace-page-header class="workspace-page-header flex items-center justify-between border-b border-slate-200 bg-white px-6 dark:border-slate-800 dark:bg-slate-900">
