        ...
        <form class="grid gap-4" @submit.prevent="handleSubmit">
          <div class="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input v-model="form.name" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" type="text" :placeholder="pageCopy.fields.namePlaceholder" />
            </div>
            <div>
              <label class="mb-1 block text-sm font-medium text-slate-700">{{ pageCopy.fields.company }}</label>
              <input v-model="form.company" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" type="text" :placeholder="pageCopy.fields.companyPlaceholder" />
            </div>
          </div>
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input v-model="form.role" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" type="text" :placeholder="pageCopy.fields.rolePlaceholder" />
            </div>
            <div>
              <label class="mb-1 block text-sm font-medium text-slate-700">{{ pageCopy.fields.email }}</label>
              <input v-model="form.email" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" type="email" :placeholder="pageCopy.fields.emailPlaceholder" />
            </div>
          </div>
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input v-model="form.phone" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" type="tel" :placeholder="pageCopy.fields.phonePlaceholder" />
            </div>
            <div>
              <label class="mb-1 block text-sm font-medium text-slate-700">{{ pageCopy.fields.need }}</label>
              <input v-model="form.need" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" type="text" :placeholder="pageCopy.fields.needPlaceholder" />
            </div>
          </div>

          <button
            type="submit"
            class="mt-2 rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:bg-slate-300"
            :disabled="!isReady"
          >
            {{ pageCopy.submit }}
          </button>

          <p v-if="submitted" class="rounded-xl bg-emerald-50 px-4 py-3 text-sm text-emerald-700">
            {{ pageCopy.success }}
          </p>
        </form>
      </section>
