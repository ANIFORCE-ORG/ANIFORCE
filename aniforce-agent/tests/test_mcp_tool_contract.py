...
EXPECTED_REQUIRED = {
    "get_project_detail": ("project_id",), "create_project": ("name",), "update_project": ("project_id",), "delete_project": ("project_id",),
    "get_campaign_detail": ("campaign_id",), "create_campaign": ("project_id", "name", "budget", "platform"), "update_campaign": ("campaign_id",),
